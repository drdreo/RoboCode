...
export class Logger implements ILogger {
  ...
  error(message: unknown, trace = '', context?: string): void {
    ...
    instance &&
    instance.error.call(instance, message, trace, context || this.context, this.isTimestampEnabled);
  }
  ...
  private static printMessage(level: 'log' | 'warn' | 'debug' | 'error', message: any, color: string | undefined, context = '', isTimeDiffEnabled?: boolean): void {
  ...
  private static logMessage(level: 'log' | 'warn' | 'debug' | 'error' | 'groupCollapsed', message: string, contextColor: string | undefined, color: string | undefined, timestampColor: string) {
